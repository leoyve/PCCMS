<template>
	<div>
		<b-container fluid>
			<h2><font color="blue">各通報來源件數統計表</font></h2>
			<b-form-row>
		...
		<div>
			<b-container fluid>
				...
				<b-form-row class="justify-content-center text-light bg-primary"><h4><strong>各通報來源件數統計表</strong></h4></b-form-row>
				<b-form-row class="justify-content-end">
...
export default {
 data(){
	return{
		...
		items:	[
			//待分文要顯示紅字，結案日期也是
			{ id: 1, source: '電話', informNum: '24', rate: '9.52',	pk: 5566 },
			{ id: 2, source: '網路', informNum: '25', rate: '9.92',	pk: 5566 },
			{ id: 3, source: 'APP行動通報', informNum: '9', rate: '3.57',	pk: 5566 },
		],
		totalNum:'252',
		totalRate:'100',
	}
