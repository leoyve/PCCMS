<template>
	<div>
		<b-container fluid>
			<h2><font color="blue">主管機關結案處理天數統計表</font></h2>
			<b-form-row>
		...
		<div>
			<b-container fluid>
				...
				<b-form-row class="justify-content-start"><font color='red'>PS.尚未分文案件均不納入統計。</font></b-form-row>
				<b-form-row class="justify-content-center text-light bg-primary"><h4><strong>主管機關結案處理天數統計表</strong></h4></b-form-row>
				<b-form-row class="justify-content-end">
...
export default {
 data(){
	return{
		...
		items:	[
			//待分文要顯示紅字，結案日期也是
			{ id: 1, closeDay: '0', closeNum: '200', rate: '83.68',	pk: 5566 },
			{ id: 2, closeDay: '1', closeNum: '30', rate: '12.55',	pk: 5566 },
			{ id: 3, closeDay: '2', closeNum: '9', rate: '3.77',	pk: 5566 },
		],
		avgDay:'2.2',
		totalNum:'239',
	}
