<template>
	<div>
		<b-container fluid>
			<h2><font color="blue">主管機關分文至主辦機關天數統計表</font></h2>
			<b-form-row>
		...
		<div>
			<b-container fluid>
				...
				<b-form-row class="justify-content-center text-light bg-primary"><h4><strong>主管機關分文至主辦機關天數統計表</strong></h4></b-form-row>
				<b-form-row class="justify-content-end">
