			...
			<b-container fluid>
				<b-table striped hover :items="items" :fields="fields" head-variant="dark">
					<template #cell(action)="row">
						<b-button size="sm" variant="success" @click="gotoParam('ReviewCaseClose', row.item)">審查</b-button>
					</template>
				</b-table>
	...
	return{
		...
		items:	[
			...
			{ id: 3, number: '11000000001', submitDate: '110/10/10', name: '吳XX',	workName: '汐止區江長抽水站星座公園兒童遊戲新建工程',	title: '行人無法過馬路', wkut:	'新北市政府',
				assignDate:	'110/07/07',	dealWkut:'工程會',	beCloseDate:'110/09/01',	photoNumber:'5',	closeDate:	'待審查結案',	pk: 5566 },
		],
		value1: '',
		value2: '',
		testBody:	[
