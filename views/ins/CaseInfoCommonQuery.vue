<template>
	<div>
		<br>
		<h3><strong><font color="brown">已處理結案通報案件查詢</font></strong></h3>
		<br>
		<br>
		<b-container >
			<b-form-row >
			...
			<b-container fluid>
				<b-table striped hover :items="items" :fields="fields" head-variant="dark">
					<template #cell(action)="row">
						<b-button size="sm" variant="outline-secondary" @click="gotoParam('CaseInfoCommonDetail', row.item)">檢視</b-button>
					</template>
				</b-table>
