 ...
 data(){
	return{
		...
		items:	[
			...
			wkut: '內政部', address:'[金門縣] 金門縣 金寧鄉寧湖路', topic:'	道路路燈安裝好迄今未亮與破損,有礙行車安全',category:'交通建設(停車場、機場、觀光遊憩、道路、橋樑、漁港等)',
			desc:'移督工系統處理。',isFa:'不納入閒置系統列管',reason:'其他不納入列管'},
