<template>
	<div>
		<br>
		<h3><strong>審查管理列管案件上傳文件檔案主畫面</strong></h3>
		<br>
		<b-container >
			<b-form-row >
			...
			<b-form-row>
				<b-form-group class="col-md-12" label-cols-md="3" content-cols-md="9" label="列管案件照片審查結果" label-align-md="right">
					<b-form-radio-group v-model="check2" :options="reviewResult" name="radio-validation-1"></b-form-radio-group>
				</b-form-group>
			</b-form-row>
			<b-form-row>
				<b-form-group class="col-md-12" label-cols-md="3" content-cols-md="9" label="列管案件照片審查情形" label-align-md="right">
		...
		<div>
			<b-container fluid>
				<b-form-row class="justify-content-center text-light bg-primary"><h4>閒置公共設施列管案件上傳文件檔案審查情形一覽表</h4></b-form-row>
				<b-table striped hover :items="items" :fields="fields" head-variant="dark">
					...
					<template #cell(action)="row">
						<b-button size="sm" variant="success" @click="gotoParam('TubeDocReview', row.item)">審核</b-button>&nbsp;
						<b-button size="sm" variant="outline-secondary" @click="gotoParam('TubeDocChange', row.item)">更換</b-button>
					</template>
				</b-table>
				<b-form-row class="justify-content-start">
					<b-button size="sm" variant="success" @click="gotoParam('TubeDocReviewBatch')" >批次審核</b-button>
				</b-form-row>
