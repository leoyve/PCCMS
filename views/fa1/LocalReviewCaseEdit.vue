    ...
    <br>
      <b-container fluid>
        <b-row class="border border-dark">
          <b-col class="col-md-12 bg-secondary text-light">閒置設施通報案件--地方主管機關審查資料</b-col>
        </b-row>
        <b-row class="border border-dark">
          <b-col class="col-md-2 text-dark"><font color="red">*</font>地方主管機關審查者姓名</b-col>
          <b-col class="col-md-10 text-left "><b-form-input/></b-col>
        </b-row>
        <b-row class="border border-dark">
          <b-col class="col-md-2 text-dark"><font color="red">*</font>地方主管機關審查者連絡電話</b-col>
          <b-col class="col-md-4 text-left "><b-form-input/></b-col>
          <b-col class="col-md-2 "><font color="red">*</font>地方主管機關審查者電子郵件地址</b-col>
          <b-col class="col-md-4 text-left"><b-form-input/></b-col>
        </b-row>
        <b-row class="border border-dark">
          <b-col class="col-md-2 text-dark"><font color="red">*</font>地方主管機關建議是否納入閒置系統列管</b-col>
        ...
        <b-row class="border border-dark">
          <b-col class="col-md-2 ">地方主管機關審查意見</b-col>
