<template>
  <div>
    <br>
    <h3><strong>填報及申請活化計畫</strong></h3>
    <br>
    <b-container >
		<b-form-row class="justify-content-end">
			<b-button size="l" variant="success"  @click="gotoParam('NewActivations', )" >新增</b-button>
		</b-form-row>
		<br>
		<b-form-row >
    ...
    <br>
	<activationsList :replaceItems="items"/>
  </div>
</template>


<script>
import activationsList from './ActivationsList.vue'
	...
	items:[ 
			{
				...
				b1:'1061117',b2:'府工道字第1060219036號', c1:'1061225',c2:'交路字第1060416418'}, diff:true,beforeForm:{},
			},
			{
				PLNNO:'1110000002',PLNNAME:'嘉義縣布袋鎮布袋鎮景山國民小學推動閒置公共設施活化--正義校區活化計畫',wkut:'嘉義縣布袋鎮景山國民小學',constName:'嘉義縣布袋鎮景山國民小學正義校區',
				plnamt:'8,214',bdate:'111/02/03', edate:'111/12/12',prjnum:2,currentForm:{}, diff:true,
				beforeForm:{a1:'1061109',a2:'頭市農字第1060028086號',
			...
			},
			{
				...
				b1:'1061117',b2:'府工道字第1060219036號',}, diff:false,beforeForm:{a1:'1061109',a2:'頭市農字第1060028086號',
				b1:'1061117',b2:'府工道字第1060219036號', c1:'1061225',c2:'交路字第1060416418', d1:'1110203', d2:'107年7月31日工程管字第10700235660號函',
				agree:false},
			}
		],
