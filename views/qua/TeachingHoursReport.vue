<template>
	<div>
		<br>
		<h3><strong><font color="brown">師資授課時數統計</font></strong></h3>
		<br>
		<b-container >
			<b-form-row>
				...
				<b-form-row class="justify-content-end">
					<b-table striped hover :items="items" :fields="fields" >
						<template #cell(action)="row">
							<b-button size="sm" variant="outline-secondary" @click="gotoParam('TeachingCourseDetail', row.item)">明細</b-button>
						</template>
					</b-table>
				</b-form-row>
			</b-container>
