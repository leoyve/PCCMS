<template>
  <div>
    ...
    <b-container >
		...
		<!--類別也有連動-->
		<b-form-row>
			<b-form-group class="col-md-12" label-cols-md="3" content-cols-md="9" label="主類別:" label-align-md="right">
				<b-form-select :options="main"></b-form-select>
			</b-form-group>
		</b-form-row>
		<b-form-row>
			<b-form-group class="col-md-12" label-cols-md="3" content-cols-md="9" label="次類別:" label-align-md="right">
